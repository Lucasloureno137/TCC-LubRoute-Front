...
@Component({
  selector: 'app-lista-usuario-cliente',
  templateUrl: './lista-usuario-cliente.component.html',
  styleUrls: ['./lista-usuario-cliente.component.css']
})
export class ListaUsuarioClienteComponent implements OnInit {
  usuarios: Usuario[] = [];
  ...
  breadcrumbItems: BreadcrumbItem[] = [
    ...
    { label: 'Usuários Técnicos', active: true }
  ];
  ...
  onAddUser(): void {
    this.router.navigate(['/app-form-usuario-cliente']);
  }
  ...
  onEditUser(): void {
    ...
    this.router.navigate([`/app-form-usuario-cliente/${this.selectedUser.publicId}`]);
  }
  ...
  onDeleteUser(): void {
    ...
    this.router.navigate([`/app-exclusion-modal/${this.selectedUser.publicId}/usuario-cliente`]);
  }
